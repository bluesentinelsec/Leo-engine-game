...
local function pulse_alpha(entry)
    ...
    if alpha < min_a then alpha = min_a end
    if alpha > max_a then alpha = max_a end
    return alpha
end
...
function leo_init()
    circles = {
        ...
        { x = 940, y = 200, radius = 70, r = 255, g = 255, b = 255, a = 80,  pulse = true, pulse_amp = 70, pulse_min = 30, pulse_max = 180 },  -- pulsing faint white
        -- Overlapping rings to highlight alpha blending
        { x = 400, y = 500, radius = 120, r = 180, g = 120, b = 255, a = 200, pulse = true, pulse_amp = 40, pulse_speed = 1.4 },
        { x = 520, y = 500, radius = 120, r = 120, g = 255, b = 180, a = 160 },
        { x = 640, y = 500, radius = 120, r = 255, g = 150, b = 80,  a = 120, pulse = true, pulse_amp = 35, pulse_speed = 2.2, pulse_phase = 1.0 }
    }
    filled = {
        ...
        { x = 940, y = 360, radius = 60, r = 255, g = 255, b = 255, a = 100, pulse = true, pulse_amp = 80, pulse_min = 40, pulse_max = 200 },
        -- Overlapping fills to show blended areas
        { x = 460, y = 520, radius = 110, r = 180, g = 120, b = 255, a = 140, pulse = true, pulse_amp = 50, pulse_speed = 1.6 },
        { x = 600, y = 520, radius = 110, r = 120, g = 255, b = 180, a = 140 },
        { x = 740, y = 520, radius = 110, r = 255, g = 150, b = 80,  a = 140, pulse = true, pulse_amp = 45, pulse_speed = 2.4, pulse_phase = 0.7 }
    }
    return true
end
...
function leo_render()
    ...
    if leo_draw_text then
        ...
        leo_draw_text("Top row: outlines | Middle: fills | Bottom: overlapping outlines/fills with pulsing alpha", 24, 48, 16, 200, 200, 200, 255)
    end
end
